...
import { Block, Button, ImageComponent, Text, CustomButton } from '../../components';
    ...
    <Block white>
      ...
      <ScrollView>
        <View style={{ margin: 16 }}>
          <Text align={'center'} size={16}>Completed missions</Text>
        </View>
        <Block
          flex={false}
          column
        ...
        <View style={{ padding: 16 }}>
          <Text color='black' size={20}>Signature</Text>
          {addSignature ? <View style={{ height: 300 }}>
            <SignatureScreen
              ref={ref}
              onEnd={handleEnd}
